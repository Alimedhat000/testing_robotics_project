...
#define IMG_WIDTH 320   /* QVGA width  (pixels) */
#define IMG_HEIGHT 240  /* QVGA height (pixels) */
...
#define SEED_CONTRAST                                                          \
  3 /* Seed pixel contrast threshold (must be this much darker) */
